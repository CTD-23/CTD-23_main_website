...
const registerTeamRC=asyncHandler(async(req,res,next)=>{
    ...
    const team_user1= await Team.findOne({email1:req.body.email1});
    const team_user2= await Team.findOne({email2:req.body.email2});
...
module.exports={registerTeamRC,registerTeamNCC,registerTeamDatawiz}
